...
export const STATIC_POSTS: InstagramPost[] = [
  { id: "1", mediaUrl: "/ig-post-1.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Custom embroidery" },
  { id: "2", mediaUrl: "/ig-post-2.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Mama & Mini sets" },
  { id: "3", mediaUrl: "/ig-post-3.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Personalized baby onesies" },
  { id: "4", mediaUrl: "/ig-post-4.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Holiday collection" },
  { id: "5", mediaUrl: "/ig-post-5.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Castle Rock favorites" },
  { id: "6", mediaUrl: "/ig-post-1.png", permalink: "https://www.instagram.com/embroideryandthreads/", caption: "Faith-based designs" },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-muted-foreground font-light max-w-md mx-auto">
            See the latest custom pieces, behind-the-scenes moments, and new collections as they happen.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3 mb-10">
          {posts.map((post, i) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/25 transition-colors duration-400 flex items-center justify-center opacity-0 group-hover:opacity-100">
